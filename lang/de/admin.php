...
return [
    ...
    'permissions' => [
        ...
        'no_user' => 'Kein Benutzer ausgewählt.',
    ...
    'menu_builder' => [
        ...
        'show_deleted_hint' => 'Auch gelöschte Kategorien anzeigen',
    ],
    ...
    'branding' => [
     ...
     'socials' => [
         'add' => '+ Add social item',
         'title' => 'Social Links',
         'hint' => 'Maximal 5 Links erlaubt.',
         'active' => 'Aktiv',
         'edit' => 'Bearbeiten',
         'delete' => 'Löschen',
         'cancel' => 'Abbrechen',
         'save' => 'Speichern',
         'updated_ok' => 'Social Link aktualisiert',
         'fields' => [
             'title' => 'Social name',
             'icon' => 'Social icon',
             'url' => 'Social URL',
    ...
    'import' => [
        ...
        'zip' => [
            'title' => 'Bilder ZIP Import',
        ],
        'rules' => 'Import-Regeln',
        'log_btn' => 'Import-Log herunterladen',
    ],
