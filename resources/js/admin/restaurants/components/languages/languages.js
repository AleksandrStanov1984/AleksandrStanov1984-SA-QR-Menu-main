// resources/js/admin/restaurants/components/languages/languages.js
...
/*document.addEventListener('DOMContentLoaded', () => {
    ...
    const limitAttr = card.dataset.limit ?? '';
    ...
    document.querySelectorAll('.lang-switch input').forEach(el => {
        ...
        el.addEventListener('change', () => {
            ...
            const checked = Array.from(
                document.querySelectorAll('.lang-switch input:checked')
            ).map(i => i.value);
    ...
    const defaultSelect = form.querySelector(
    ...
    if (defaultSelect) {
        ...
        defaultSelect.addEventListener('change', () => {
            ...
            card.dataset.defaultLocale = defaultLocale;
