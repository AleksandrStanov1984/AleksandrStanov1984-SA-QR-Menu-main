// resources/js/admin/restaurants/components/permissions/permissions.js

/*(function () {

    const app = document.getElementById('permApp');
    if (!app) return;
    ...
    const isEdit = app.dataset.isEdit === 'true';
    ...
    document.getElementById('permSaveBtn')
        ?.addEventListener('click', async () => {

            const inputs = Array.from(
                document.querySelectorAll(
                    '#permModalBody input[type="checkbox"]'
                )
            );
