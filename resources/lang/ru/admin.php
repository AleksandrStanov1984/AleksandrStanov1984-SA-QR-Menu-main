...
return [
    ...
    'about' => [
            ...
            'p1' => 'Уже несколько лет я разрабатываю веб-системы, интернет-магазины и промышленные приложения — от онлайн-витрин и личных кабинетов до тестовых стендов для силовой электроники и умных контроллеров элеваторов.',
            ...
            'p3' => 'Если вам нужна новая веб-система, интернет-магазин или интеграция тестовых стендов и контроллеров — напишите мне.',
