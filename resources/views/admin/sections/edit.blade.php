                        ...
                        <select name="template_key" required>
                            @foreach($templates as $tpl)
                                <option value="{{ $tpl->key }}"
                                    @selected(old('template_key', $restaurant->template_key) === $tpl->key)>
                                    {{ $tpl->name }}
                                </option>
                            @endforeach
                        </select>
    ...
    <div class="card" style="margin-top:16px;">
        ...
        <div class="mut" style="font-size:13px;">
            ...
            <div style="margin-top:8px;">
                <code>public/assets/restaurants/{{ $restaurant->id }}/</code>
            </div>
            ...
            <div style="margin-top:6px;">
                ...
                <code>branding/backgrounds/light</code>,
                <code>branding/backgrounds/dark</code>,
                <code>menu/items</code>,
                <code>qr/raw</code>,
                <code>qr/logo</code>,
                <code>qr/background</code>,
                <code>qr/final</code>.
            </div>
        </div>
    </div>
